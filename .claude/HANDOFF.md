...
| 5a | **#518 (CRITICAL)** one organisation's administrator can change any account | **planning run starting about 06:40** (script `.claude-work/resume/wf-518.js`; plan, build, check; nothing committed by the run) |
