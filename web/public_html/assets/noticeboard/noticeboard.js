...
/* WebMS Noticeboard — runtime-compiled bundle (needs 'unsafe-eval'). Fallback. */
(function(){
  ...
  function inject(){
    if(document.getElementById('__nb_xdc'))return;
    var mount=document.getElementById('noticeboard-root')||document.body;
    var xdc=document.createElement('x-dc');xdc.id='__nb_xdc';xdc.innerHTML=TEMPLATE;
    var s=document.createElement('script');s.type='text/x-dc';s.setAttribute('data-dc-script','');
    if(PROPS)s.setAttribute('data-props',PROPS);s.textContent=LOGIC;
    mount.appendChild(xdc);mount.appendChild(s);
  }
