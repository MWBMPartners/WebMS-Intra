...
/**
 * -----------------------------------------------------------------------------
 * Asset Tracker — Save Licence Assignment (stub) 📦
 * -----------------------------------------------------------------------------
 * POST handler — assigns a licence seat to a device or user.
 *
...
$pageTitle   = 'Save Licence Assignment';
$pageSection = 'assets';
$breadcrumbs = ['Dashboard' => '/', 'Assets' => '/assets', 'Save Licence Assignment' => ''];
