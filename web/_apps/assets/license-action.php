...
/**
 * -----------------------------------------------------------------------------
 * Asset Tracker — Licence Assignment Action (stub) 📦
 * -----------------------------------------------------------------------------
 * POST handler — releases a licence seat assignment.
 *
...
$pageTitle   = 'Licence Assignment Action';
$pageSection = 'assets';
$breadcrumbs = ['Dashboard' => '/', 'Assets' => '/assets', 'Licence Assignment Action' => ''];
