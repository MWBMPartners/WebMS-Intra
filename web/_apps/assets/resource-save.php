...
/**
 * -----------------------------------------------------------------------------
 * Asset Tracker — Save Asset Resource (stub) 📦
 * -----------------------------------------------------------------------------
 * POST handler — attaches a manual/guide/photo/receipt to an asset.
 *
...
$pageTitle   = 'Save Asset Resource';
$pageSection = 'assets';
$breadcrumbs = ['Dashboard' => '/', 'Assets' => '/assets', 'Save Asset Resource' => ''];
