...
/**
 * -----------------------------------------------------------------------------
 * Asset Tracker — Asset Labels PDF (stub) 📦
 * -----------------------------------------------------------------------------
 * Generates a printable PDF sheet of asset labels.
 *
...
$pageTitle   = 'Asset Labels PDF';
$pageSection = 'assets';
$breadcrumbs = ['Dashboard' => '/', 'Assets' => '/assets', 'Asset Labels PDF' => ''];
