...
/**
 * -----------------------------------------------------------------------------
 * Asset Tracker — Asset Loan Action (stub) 📦
 * -----------------------------------------------------------------------------
 * POST handler — approve/decline/return an asset loan.
 *
...
$pageTitle   = 'Asset Loan Action';
$pageSection = 'assets';
$breadcrumbs = ['Dashboard' => '/', 'Assets' => '/assets', 'Asset Loan Action' => ''];
