...
/**
 * -----------------------------------------------------------------------------
 * Asset Tracker — Download Asset Resource (stub) 📦
 * -----------------------------------------------------------------------------
 * Streams an uploaded asset resource file.
 *
...
$pageTitle   = 'Download Asset Resource';
$pageSection = 'assets';
$breadcrumbs = ['Dashboard' => '/', 'Assets' => '/assets', 'Download Asset Resource' => ''];
