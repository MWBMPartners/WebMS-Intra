...
/**
 * -----------------------------------------------------------------------------
 * Asset Tracker — View Asset (stub) 📦
 * -----------------------------------------------------------------------------
 * View a single asset's full detail — ownership, loans, maintenance, licences, identifiers, resources.
 *
...
$pageSection = 'assets';
$breadcrumbs = ['Dashboard' => '/', 'Assets' => '/assets', 'View Asset' => ''];
