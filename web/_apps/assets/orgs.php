...
/**
 * -----------------------------------------------------------------------------
 * Asset Tracker — Asset Organisations (stub) 📦
 * -----------------------------------------------------------------------------
 * Manage external organisations that own/lend/borrow assets.
 *
...
$pageTitle   = 'Asset Organisations';
$pageSection = 'assets';
$breadcrumbs = ['Dashboard' => '/', 'Assets' => '/assets', 'Asset Organisations' => ''];
