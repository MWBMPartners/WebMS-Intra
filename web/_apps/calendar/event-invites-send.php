...
$stmt = $mysqli->prepare('SELECT eventID, eventName, eventSlug, startDateTime FROM tblEvents WHERE eventID = ? AND siteID = ? AND isDeleted = 0 AND externalFeedID IS NULL');
