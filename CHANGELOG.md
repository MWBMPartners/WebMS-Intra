...
PR #340 — events platform overhaul + COP + ChurchMS verticals + ops hygiene. **36 issues across 39 commits in one consolidated PR**.
...
(Originally drafted under 1.2.0 — shipped as part of the 1.3.0 release.)
